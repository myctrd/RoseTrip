...
public class LocalizationManager : MonoBehaviour {
    ...
    {
        string str_lan = PlayerPrefs.GetString("3KINGDOMS_LANGUAGE");
        switch(str_lan)
        {
            case "CHINESE":
                m_Language = "CHINESE";
    ...
    public void SwitchLanguage()
    {
        ...
        {
            PlayerPrefs.SetString("3KINGDOMS_LANGUAGE", "CHINESE");
        }
        else if (m_Language == "CHINESE")
        {
            PlayerPrefs.SetString("3KINGDOMS_LANGUAGE", "ENGLISH");
        }
        InitLanguage();
